...
int freeAll(double *&d_new1, double *&d_new, double *&d_G,
        double *&d_I, double *&d_mu, double *&d_d,
        double *&d_c, double *&d_, double *&d_beta,
        double *&d_betaOLS, double *&d_gamma,
        double *&d_cmax, double *&d_upper1,
