...
int lars(double *&d_X, double *&d_Y, double *&d_mu,
    double *&d_c, double *&d_, double *&d_G, double *&d_I,
    double *&d_beta, double *&d_betaOLS, double *&d_d,
    double *&d_gamma, double *&d_cmax, double *&d_upper1,
    double *&d_normb, int *&d_lVars, int *&d_nVars,
    int *&d_ind, int *&d_step, int *&d_done, int *&d_lasso,
    int M, int Z, int *d_act, int l, double g)
{
    time_t timer;
